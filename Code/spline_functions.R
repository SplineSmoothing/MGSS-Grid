...
#####--------------------------------------------
##### computes the product (Phi^T%*%(Phi%*%alpha)), where Phi^T is given as a kronecker product
MVP_spline = function(tPhiPhi_list, alpha){
  
  base <- MVP_kronecker_rcpp(tPhiPhi_list, alpha)
  return(base)
